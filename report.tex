...
\begin{document}
   ...
   \begin{figure}[H]
    ...
    a = 0.3255 nm, c = 0.3198 nm.

    The broadening results from finite lateral crystallite size and tilt of the crystallites.

    \begin{equation}
        \frac{\Delta a}{a} = \frac{a_{substrate}-a^{relax}_{film}}{a_{substrate}}
        \label{eq4}
    \end{equation}

    With $a^{relax}_{film} = a_{ZnO} = 3.255 \AA$ from experiment, $a_{substrate} = a_{Al_2O_3} = 4.7577 \AA$ from appendix B, lattice mismatch is 0.3158.


    %8
    \vspace{0.5cm}
    \textbf{Question 8:} {\it Determine the c-lattice constant of sample C. Why was the 006-reflex instead of the (002) reflex used for this purpose? ...Use this relation with the above determined value for cZnO to calculate the Mg-content of sample C. Estimate the error of the obtained result by assuming that the Equation 
(49) is accurate.}
