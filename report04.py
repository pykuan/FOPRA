...
with open('value.tex', 'a') as f:
    f.write('\n')
    f.write(rf'\renewcommand\reportFOURfwhmA{{{FWHM_omega_A:.4f}}}' + '\n')
    f.write(rf'\renewcommand\reportFOURlxyA{{{lxy_A*10**9:.3f}}}' + '\n')
    f.write(rf'\renewcommand\reportFOURdsA{{{dislocation_screw_A*10**-12:.3f}}}' + '\n')
    f.write(rf'\renewcommand\reportFOURfwhmB{{{FWHM_omega_B:.4f}}}' + '\n')
    f.write(rf'\renewcommand\reportFOURlxyB{{{lxy_B*10**9:.3f}}}' + '\n')
    f.write(rf'\renewcommand\reportFOURdsB{{{dislocation_screw_B*10**-10:.3f}}}' + '\n')
